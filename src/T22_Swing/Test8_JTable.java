...
public class Test8_JTable extends JFrame{
...
//		JTable의 최대 크기 지정 : 	table.getColumnModel().getColumn(열번호).setMaxWidth(크기);
		
//		JTable의 크기 고정 : 	table.getColumnModel().getColumn(열번호).setResizable(false);
		
//		JTable의 : 셀의 위치 고정	table.getTableHeader().setReorderingAllowed(false);
		
//		데이터 가운데 정렬 : tcm.getColumn(i).setCellRenderer(dtcr);
